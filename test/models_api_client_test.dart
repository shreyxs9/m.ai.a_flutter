...
void main() {
  ...
  group('models fromJson', () {
    test('ProjectListItem applies rolling-deploy defaults and parses dates', () {
    ...
    test('Message parses nested recipient, reply preview, nulls, and dates', () {
      ...
      expect(message.toJson()['reply_to_preview'], isA<Map<String, dynamic>>());
    });
  ...
  group('ApiException parsing', () {
    test('uses detail from JSON error bodies', () async {
      final client = ApiClient(dio: _dioWithResponse(
        statusCode: 400,
